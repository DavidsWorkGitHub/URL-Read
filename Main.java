...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Enter URL like https://www.example.com :");
        webSite = input.next();

        URL website = new URL(webSite);
        try (BufferedReader dataIn = new BufferedReader(new InputStreamReader(website.openStream()))) {


            String sentence;


            while ((sentence = dataIn.readLine()) != null) {
